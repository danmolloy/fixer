...
import { getDateRange } from '../api/create/functions';
          ...
          await axios
            .post('/fixing/contactMessage/api/update', {
              ...
              data: {
                ...
                strictlyTied:
                  values.type === 'BOOKING' || values.type === 'AUTOBOOK'
                    ? true
                    : values.strictlyTied,
                type: values.type,
          ...
          <Form className='flex w-full flex-col px-2 py-8 lg:w-2/3'>
            ...
            <div className=''>
              ...
              >
                <option
                  value='RESPONDED'
                  disabled={props.values.type === 'AUTOBOOK'}
                >
                  Responded
                </option>
                <option value='NOTCONTACTED' disabled={false}>
                  Not Contacted
                </option>
                <option
                  value='AWAITINGREPLY'
            ...
            <div className='my-2'>
              <label>
                <Field
                  disabled={
                    props.isSubmitting ||
                    props.values.type === 'AUTOBOOK' ||
                    props.values.type === 'BOOKING'
                  }
                  className='m-1'

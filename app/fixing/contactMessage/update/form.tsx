...
export default function UpdateContactMessage(props: UpdateContactMessageProps) {
  ...
  const initialVals = {
    ...
    accepted: contact.accepted === true ? "true" : contact.accepted === false ? "false" : "",
    ...
    try {
      await axios.post("/fixing/contactMessage/api/update", {
        ...
        data: {
          ...
          accepted: values.accepted === "true" ? true : values.accepted === "false" ? false : null,
    ...
    initialValues={initialVals}>
      {props => (
        <Form>
          ...
          <p>{contact.contact.firstName} {contact.contact.lastName} ({instrument})</p>
          ...
          <div>
            ...
            {event.calls.map(i => (
              ...
              <p>{DateTime.fromJSDate(new Date(i.startTime)).toFormat('DD')}</p>
                ...
                <Field checked={props.values.calls.includes(String(i.id))} type="checkbox" name="calls" value={String(i.id)} />
              </label>
            ))}
         ...
         <div>
         <label>
            <Field checked={props.values.strictlyTied} type="checkbox" name="strictlyTied"/>
            Strictly Tied
          </label>
         <ErrorMessage name="strictlyTied">
          ...
          <div>
          <label>
            <Field checked={props.values.urgent} type="checkbox" name="urgent"/>
            Urgent
          </label>
          ...
          <TextInput id="player-position-input" label="Position" name="position" />
          <TextInput id="player-message-input" label="Message to Player" name="playerMessage" />

...
const createContactMessages = async(data: createContactMessage) => {
  ...
  let currentHighest = currentCalls.length > 0 ? currentCalls[currentCalls.length - 1].indexNumber + 1 : 1

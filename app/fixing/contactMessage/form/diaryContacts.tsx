...
export default function DiaryContacts(props: DiaryContactsProps) {
  const { sectionContacts, eventCalls, currentContacts, appendedContacts } =
    props;
  const [sortContacts, setSortContacts] = useState<
    'alphabetical' | 'category' | 'role'
  >('alphabetical');
                ...
                <tr>
                  ...
                  <th className='p-1 py-2 text-start'>
                    <button
                      onClick={(e) => {
                        e.preventDefault();
                        setSortContacts('alphabetical');
                      }}
                      className='flex flex-row items-center hover:text-gray-700'
                    >
                      Name
                      <div className='w-3'>
                        {sortContacts.toLocaleLowerCase() ===
                          'alphabetical' && <FaCaretDown />}
                      </div>
                    </button>
                  </th>
                  <th className='p-1 py-2 text-start'>

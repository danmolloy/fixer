...
export default function EventInfo(props: EventInfoProps) {
  ...
  return (
    <tbody data-testid="event-info-body" className={" w-full  rounded-lg flex flex-col"}>
      ...
      <tr data-testid="calls-row" className="flex flex-col  md:flex-row p-4 w-full lg:items-center lg:justify-evenly ">

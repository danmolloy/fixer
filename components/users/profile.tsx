...
export default function UserProfile(props: UserProfileProps) {
  ...
  return (
    <div data-testid="user-profile-div" className="flex flex-col w-full ">
      <div className="flex flex-row rounded lg:w-2/3 border border-slate-400 shadow" data-testid="profile-header">
        <div className="rounded-md shadow overflow-hidden m-2">
          <Image src={"http://placebeard.it/200/200"} width={200} height={200} alt="Placeholder for a profile pic" title="Profile picture placeholder" />
        </div>

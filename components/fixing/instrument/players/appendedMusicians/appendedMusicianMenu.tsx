...
export default function AppendedMusicianMenu(props: AppendedMusicianMenuProps) {
  ...
  return (
    <div data-testid="musician-menu" tabIndex={-1}  ref={ref} onBlur={() => setTimeout(() => setShowMenu(false), 150)} className="flex flex-col border rounded shadow items-center absolute  bg-white -ml-4 -mt-36">

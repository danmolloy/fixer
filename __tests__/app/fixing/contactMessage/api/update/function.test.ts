...
jest.mock("../../../../../../app/fixing/contactMessage/api/update/depFunctions", () => ({
...
describe("updateContactMessage", () => {
  ...
  it("if a booking is being accepted, addMeterEvent(subscriptionID) & releaseDeppers(args) is called", async () => {
    ...
    expect(addMeterEvent).toHaveBeenCalledWith(mockData.eventSection.event.ensemble.stripeSubscriptionId);

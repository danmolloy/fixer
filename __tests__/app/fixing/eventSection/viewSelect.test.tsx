...
import SectionViewSelect, { SectionSelectProps } from "../../../../app/fixing/eventSection/viewSelect";
...
describe("<SectionViewSelect />", () => {
  ...
  it("Availability select btn is in the document, states check count and calls setSelectedView(AVAILABILITY) on click", () => {
    ...
    expect(availBtn).toHaveTextContent(`Availability (${localMockProps.availabilityCheckCount})`);
    act(() => {

...
import ResponseForm, { ResponseFormProps } from "../../../../../app/fixing/response/[token]/form";
...
import { responseConfEmail, SentEmailData } from "../../../../../app/sendGrid/lib";
...
describe("<ResponseForm />", () => {
  ...
  it('on successful submit, prisma.contactMessage.update, responseConfEmail, axios.post & useRouter are called', async () => {
    ...
    expect(responseConfEmail).toHaveBeenCalledWith({
      ...
      accepted: true,
      bookingOrAvailability: localMockProps.contactMessage.bookingOrAvailability,
    });

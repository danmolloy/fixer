...
import ResponseHeader, { ResponseHeaderProps } from "../../../../../app/fixing/response/[token]/header";
...
describe("<ResponseHeader />", () => {
  ...
  it("if availability, expected text is in the document", () => {
    ...
    expect(responseHeader.textContent).toMatch(`Dear ${mockProps.contactFirstName}, ${mockProps.fixerName} would like you to indicate your decision below regarding the following gig.`);
  })
})
...
describe("<ResponseHeader />", () => {
  ...
  it("if autobooked, expected text is in the document", () => {
    ...
    expect(responseHeader.textContent).toMatch(`Dear ${mockProps.contactFirstName}, ${mockProps.fixerName} has booked you for the following gig.`);
  })
})

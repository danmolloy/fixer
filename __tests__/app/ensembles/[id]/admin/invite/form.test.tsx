...
import InviteAdminForm, { InviteAdminFormProps } from "../../../../../../app/ensembles/[id]/admin/invite/form";
...
describe("<InviteAdminForm />", () => {
  ...
  it("on click, submit btn calls axios.post() with expected attrs if all fields valid", async () => {
    ...
    await act(async () => {
      fireEvent.change(positionInput, {target: { value: mockData.positionTitle}})
    })
    ...
    expect(axios.post).toHaveBeenCalledWith("/ensembles/admin/api/invite", mockData)
  })
})
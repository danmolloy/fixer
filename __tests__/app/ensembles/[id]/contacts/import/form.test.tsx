...
import ImportForm, { ImportFormProps } from "../../../../../../app/ensembles/[id]/contacts/import/form";
...
describe("<ImportForm />", () => {
  ...
  it("Add manually btn is in the document and renders an empty table on click", async () => {
    ...
    const regex = /^selectFluteOboeClarinetBassoonHornTrumpetTromboneTubaTimpaniPercussionOrganPianoViolin 1Violin 2ViolaCelloDouble Bass$/

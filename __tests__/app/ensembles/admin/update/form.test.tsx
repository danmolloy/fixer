...
import UpdateAdminForm, {
  InviteAdminFormProps,
} from '../../../../../app/ensembles/admin/update/form';
...
describe('<UpdateAdminForm />', () => {
  ...
  it('submit btn calls axios.post() and useRouter() if form complete', async () => {
    ...
    expect(axios.post).toHaveBeenCalledWith('/ensembles/admin/api/update', {

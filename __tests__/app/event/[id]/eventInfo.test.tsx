...
describe('<EventInfo />', () => {
  ...
  it('created datetime is in the document with label', () => {
    ...
    expect(createdAt.textContent).toMatch(
      String(
        DateTime.fromJSDate(new Date(mockProps.event.createdAt)).toFormat(
          'HH:mm DD'
        )
      )
    );
  ...
  it('updated datetime is in the document with label', () => {
    ...
    expect(updatedAt.textContent).toMatch(
      String(
        DateTime.fromJSDate(new Date(mockProps.event.updatedAt)).toFormat(
          'HH:mm DD'
        )
      )
    );

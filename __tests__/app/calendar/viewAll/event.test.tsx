...
import EventOverview, { EventOverviewProps } from "../../../../app/calendar/viewAll/event"
...
describe("<EventOverview />", () => {
  ...
  it("if !fixed, states numbers in each section yet to book", () => {
    ...
    expect(fixingOverview.textContent).toMatch("Nose Bleed section (0/1 booked, 1 remains on list)")
  })
